...
export const metadata: Metadata = {
  title: 'Doctor Home Visits Vizag | 24/7 MBBS Doctors at Doorstep | Book Now',
  description: 'Book certified MBBS doctors for home visits in Visakhapatnam within 30 minutes. MVP Colony, Beach Road, Madhurawada, Gajuwaka coverage. Emergency medical care at home.',
  keywords: [
    'doctor home visit vizag', 'home doctor visakhapatnam', 'emergency doctor vizag',
    'MBBS doctor home visit', 'doctor at home MVP colony', 'medical care vizag',
    'doctor home visit beach road', 'emergency medical vizag', 'home healthcare visakhapatnam',
    'certified doctor vizag', 'doctor visit madhurawada', 'medical service gajuwaka'
  ],
  openGraph: {
    title: 'Doctor Home Visits Vizag - 30 Min Response Time',
    description: 'Certified MBBS doctors at your doorstep in Visakhapatnam. MVP Colony, Beach Road, Madhurawada coverage.',
        url: 'https://doctorbookings.in/vizag',
    siteName: 'Doctor Bookings',
    images: [{
      url: '/vizag-doctor-home-visit.jpg',
      width: 1200,
      height: 630,
      alt: 'Doctor Home Visits in Visakhapatnam - Certified MBBS doctors'
    }],
    locale: 'en_IN',
    type: 'website',
  },
  twitter: {
    ...
    title: 'Doctor Home Visits Vizag - Book Now',
    description: 'Certified doctors at your doorstep in Visakhapatnam within 30 minutes',
    images: ['/vizag-doctor-home-visit.jpg'],
  },
  alternates: {
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-left">
                ...
                <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-green-600 mb-6 text-left md:text-center">
                  Certified Doctors for Home Visit <span className="text-blue-600">in Visakhapatnam</span>
                </h1>
                <p className="text-xl md:text-3xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed text-left md:text-center">
                  certified doctors at your doorstep in Vizag within 30 minutes. Skip hospital visits - we bring quality healthcare to your home across Visakhapatnam.
                </p>
                <p className="text-base text-gray-500 mb-12 max-w-3xl mx-auto text-left md:text-center">
                  ...
                  MVP Colony, Beach Road, Bheemli, Gajuwaka, Rushikonda, hanumanthwaka 
                  and many more....
                </p>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Bringing quality healthcare to your doorstep in Visakhapatnam. MBBS-certified doctors available 24/7.
                </p>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-4">Services in Vizag</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-4">Contact Vizag</h4>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                            <p>&copy; 2025 Doctor Bookings. All rights reserved. | Serving Visakhapatnam with quality healthcare.</p>
